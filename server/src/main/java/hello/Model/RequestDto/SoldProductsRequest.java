 ...
 */
public class SoldProductsRequest implements Serializable {
    private long sellerId;
    private String buyumAty;
    private String buyumSany;

    public SoldProductsRequest()
    {

    }

    public SoldProductsRequest(long sellerId, String buyumAty, String buyumSany) {
